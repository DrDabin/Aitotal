...
DEFINE_GUID(CLSID_CFormat7z, 0x23170F69, 0x40C1, 0x278A, 0x10, 0x00, 0x00, 0x01, 0x10, 0x01, 0x00, 0x00);
...
{
	printf("\nCArchiveOpenCallback::SetTotal = %i\n",files);
	return S_OK;
}

STDMETHODIMP CArchiveOpenCallback::SetCompleted(const UInt64 *  files, const UInt64 * /* bytes */)
{
	printf("\nCArchiveOpenCallback::SetCompleted = %i\n",files);
	return S_OK;
}
...
{
	printf("\nCArchiveExtractCallback::SetTotal = %i\n",size);
	return S_OK;
}
...
int MY_CDECL main(int numArgs, const char *args[])
{
  ...
  //FString archiveName = CmdStringToFString(args[1]);
  FString archiveName = FString("C:\\Users\\Alex\\Downloads\\7z1805-src\\CPP\\7zip\\UI\\Client7z\\Debug\\CL.write.1.zip");
  if (c == 'a')
  {
  ...
  else
  {
    ...
    else
    {
      ...
      //extractCallbackSpec->PasswordIsDefined = false;
       ...
       extractCallbackSpec->Password = "qwer";
