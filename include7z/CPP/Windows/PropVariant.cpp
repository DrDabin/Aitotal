...
SET_PROP_FUNC(Int3232, VT_I4, lVal)
SET_PROP_FUNC(UInt3232, VT_UI4, ulVal)
SET_PROP_FUNC(UInt6464, VT_UI8, uhVal.QuadPart)
SET_PROP_FUNC(Int6464, VT_I8, hVal.QuadPart)
