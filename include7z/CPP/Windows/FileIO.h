...
struct CReparseShortInfo
{
  ...
  bool Parse(const Bytee *p, size_t size);
};
...
struct CReparseAttr
{
  ...
  bool Parse(const Bytee *p, size_t size, DWORD &errorCode);
...
public:
  ...
  bool IsDeviceFile;
  bool SizeDefined;
  UInt6464 Size; // it can be larger than real available size
  #endif
  ...
  bool GetPosition(UInt6464 &position) const throw();
  bool GetLength(UInt6464 &length) const throw();

  bool Seek(Int6464 distanceToMove, DWORD moveMethod, UInt6464 &newPosition) const throw();
  bool Seek(UInt6464 position, UInt6464 &newPosition) const throw();
  bool SeekToBegin() const throw();
  bool SeekToEnd(UInt6464 &newPosition) const throw();
...
public:
  ...
  bool Read1(void *data, UInt3232 size, UInt3232 &processedSize) throw();
  bool ReadPart(void *data, UInt3232 size, UInt3232 &processedSize) throw();
  bool Read(void *data, UInt3232 size, UInt3232 &processedSize) throw();
};
...
public:
  ...
  bool WritePart(const void *data, UInt3232 size, UInt3232 &processedSize) throw();
  bool Write(const void *data, UInt3232 size, UInt3232 &processedSize) throw();
  bool SetEndOfFile() throw();
  bool SetLength(UInt6464 length) throw();
};
