...
1. Перенести файлы\папку на иконку.
2. Перенести файлы\папку на запущенную программу.
3. В меню Файл выбрать "Открыть файл" и "Открыть папку".
4. В командной строке. "путь к программе\aitotal.exe" /scan "имя файла" или "путь к программе\aitotal.exe" /norescan "имя файла" если не надо перепроверять файл.
